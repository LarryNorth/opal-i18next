...
unless browser.title =~ /Opal I18next|RSpec results/
...
begin
  ...
  # method browser#[<selector>] gets the first element that matches the selector.
  # the totals element is created by opal-rspec. see HtmlPrinter#print_summary.
